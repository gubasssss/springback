...
public class JwtUtils {
    ...
    @Value("${api.key:default_secret_key_default_secret_key_123456}")
    private String KEY;
    ...
    public Authentication parseToken(String token) throws java.io.IOException, JsonProcessingException {
        ObjectMapper mapper = new ObjectMapper();
